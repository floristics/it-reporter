<section><div class="row">
    ...
    <div class="col-lg-3 col-md-6">
        <div class="info-box bg-yellow-gradient">
            ...
            <div class="info-box-content bg-yellow">
                <span class="info-box-text">Организаций</span>
                <span class="info-box-number">237</span>
                <div class="progress">
                    <div class="progress-bar" style="width: 74%"></div>
                </div>
                <span class="progress-description">
                  <strong>74%</strong> обслуживает ЦИТ
                </span>
            </div>
        </div>
    </div>
    <div class="col-lg-3 col-md-6">
        <div class="info-box bg-green-gradient">
            ...
            <div class="info-box-content">
                <span class="info-box-text">Заявок сегодня</span>
                <span class="info-box-number">673</span>
                <div class="progress">
                    <div class="progress-bar" style="width: 12%"></div>
                </div>
                <span class="progress-description">
                  <strong>12%</strong> Решено
                </span>
            </div>
        </div>
    </div>
    <div class="col-lg-3 col-md-6">
        <div class="info-box bg-aqua-gradient">
            ...
            <div class="info-box-content">
                <span class="info-box-text">Выдано доступов в сеть</span>
                <span class="info-box-number">2051</span>
                <div class="progress">
                    <div class="progress-bar" style="width: 0"></div>
                </div>
                <span class="progress-description">
                  <strong>130</strong> в прошлом месяце
                </span>
            </div>
        </div>
    </div>
    <div class="col-lg-3 col-md-6">
        <div class="info-box bg-blue-gradient">
            <span class="info-box-icon bg-dark-blue"><i class="fa fa-file-excel-o"></i></span>
            <div class="info-box-content">
                <span class="info-box-text">Не защитили бюджет</span>
